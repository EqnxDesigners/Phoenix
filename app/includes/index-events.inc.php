<section class="row" id="index-events">
    ...
    <div class="small-12 columns shor-for-small-only">
        <h3>Prochain événement</h3>
    </div>
    <div class="row events-tab">
        <div class="medium-4 columns hide-for-small-only">
            <ul class="tabs vertical" data-tab>
                <li class="tab-title active"><a href="#panel11">Event 1502 <span>27 mars 2015</span></a></li>
                <li class="tab-title"><a href="#panel21">Event 1507 <span>27 juillet 2015</span></a></li>
            </ul>
        </div>
