...
<!-- SOUS-MENU -->
<div id="submenu">
    <a href="?module=<?php echo $_SESSION['module']; ?>&page=creation&gerer=<?php echo $elem_to_manage; ?>">Ajouter un média</a>
    &nbsp;|&nbsp;
    <a class="sub-tool" role="open-add-format">Formats personnalisés</a>
    &nbsp;|&nbsp;
    <a href="?module=<?php echo $_SESSION['module']; ?>&page=creation&gerer=slideshow">Slideshow</a>
</div>

<!-- GESTION DES FORMATS PREDEFINIS -->
<div class="row pop-box" id="add-format" style="margin-bottom: 40px; background: #efefef; padding: 15px 0;">
...
<div class="row">
    ...
    <div class="twelve columns no-gutter">
        <div class="twelve columns" id="lst-all-medias">
            <?php echo $module->getLayoutMedias(); ?>
        </div>
        <!--
