...
<div id="submenu">
	<a href="?module=<?php echo $_SESSION['module']; ?>&page=gestion&gerer=<?php echo $_GET['gerer']; ?>">Fermer</a>
        &nbsp;|&nbsp;
        <a class="tool" role="new-article">Nouvel article</a>
</div>
            ...
            <div class="three columns text-right">
                <?php
                    /*if(isset($_SESSION['id_article'])) {
                        echo $module->getSelectLangues($_SESSION['lang'], $_SESSION['id_article']);
                    }
                    else {
                        echo $module->getSelectLangues($_SESSION['lang']);
                    }
                     * 
                     */
                    echo $module->getSelectLangues($_SESSION['lang']);
?>
        ...
        <div class="three columns" id="lst_all_medias">
            ...
            <!--
            <div class="row">
                <div class="two columns"><img src="../images/bton_fr.png"></div>
                <div class="ten columns">Etat de publication</div>
                <div class="two columns"><img src="../images/bton_de.png"></div>
                <div class="ten columns">Etat de publication</div>
                <div class="two columns"><img src="../images/bton_en.png"></div>
                <div class="ten columns">Etat de publication</div>
            </div>
            -->
        </div>
