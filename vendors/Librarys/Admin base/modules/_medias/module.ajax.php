...
if(isset($_POST['action']) && $_POST['action'] == 'masterSwitch') {
	$module = new MEDIAS('images');
        mysql_query("UPDATE lib_medias SET active = '".$_POST['new_value']."' WHERE id = '".$_POST['id']."'");	
	echo $module->getMasterSwitch($_POST['id'], $_POST['new_value'], $_POST['element']);
}

//Affichage des médias par type
if(isset($_POST['action']) && $_POST['action'] == 'getMediasByType') {
    echo $module->getLayoutMedias($_POST['type']);
}
